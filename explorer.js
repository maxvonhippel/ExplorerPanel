...
function show_modal(name) {
	...
	image.style.maxHeight = '35%';
	image.style.width = 'auto';
	image.style.margin = 'auto';
	title.style.margin = 'auto';
	description.style.margin = 'auto';
	description.style.maxWidth = '45%';
	description.style.maxHeight = '45%';
	title.style.maxWidth = '45%';
	title.style.maxHeight = '10%';
